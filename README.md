...
* **Finalist (F Award)** | *MCM/ICM (Mathematical Contest in Modeling), 2026*
    * Top 1%~2% worldwide. Focused on data-driven modeling and advanced predictive algorithms.
* **National Top 8 & Second Prize** | *RoboCup 3v3 Competition, 2026*
    * Developed and optimized multi-agent coordination and real-time control strategies for autonomous robotic agents.
